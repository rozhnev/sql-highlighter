(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.SQLHighlighter = factory();
    }
}(typeof self !== 'undefined' ? self : this, function () {
    class SQLHighlighter {
        // CSS selector used to find code blocks to highlight
        static codeBlockSelector = 'pre code';
        // class name (on a code block) that marks it as SQL for highlightCodeSQL
        static sqlLanguageClass = 'language-sql';
        ...
        static getCodeBlocks() {
            return document.querySelectorAll(SQLHighlighter.codeBlockSelector);
        }
        static highlightCode(block) {
            if (block.classList.contains(SQLHighlighter.sqlLanguageClass)) {
